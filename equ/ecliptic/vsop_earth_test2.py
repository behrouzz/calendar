...
from hypatie.time import utc2tt, datetime_to_jd, jd_to_datetime

utc1 = datetime(2023,3,20, 21)
utc2 = datetime(2023,3,20, 22)
tt1 = utc2tt(utc1)
tt2 = utc2tt(utc2)

JD1 = datetime_to_jd(tt1)
JD2 = datetime_to_jd(tt2)

JDs = np.linspace(JD1, JD2, 1000)
Ts = (JDs-2451545)/365250
lons = earth_lon(Ts, data_arr)
i_min = np.argmin(np.abs(lons-180))
t_vernal = jd_to_datetime(JDs[i_min])
print(t_vernal)
#=======================================================
'''
